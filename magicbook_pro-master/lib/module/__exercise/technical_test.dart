  ...
  List list = [
    ...
    () {
      ...
      List<Map<String, dynamic>> output = <Map<String, dynamic>>[
        <String, dynamic>{"fruit": "apple", "color": "red"},
        <String, dynamic>{"fruit": "banana", "color": "yellow"},
        <String, dynamic>{"fruit": "cherry", "color": "red"},
        <String, dynamic>{"fruit": "date", "color": "brown"},
        <String, dynamic>{"fruit": "fig", "color": "purple"}
      ];
      // --- End of Answer ---
